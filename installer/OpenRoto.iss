...
; Keep the proven bridge implementation unchanged and put the removal-aware wrapper in front of it.
Source: "..\resolve\OpenRoto.py"; DestDir: "{userappdata}\Blackmagic Design\DaVinci Resolve\Support\OpenRoto"; DestName: "OpenRotoBridgeBase.py"; Flags: ignoreversion
Source: "..\resolve\OpenRotoRemovalBridge.py"; DestDir: "{userappdata}\Blackmagic Design\DaVinci Resolve\Support\OpenRoto"; DestName: "OpenRotoBridge.py"; Flags: ignoreversion
...
Type: files; Name: "{userappdata}\Blackmagic Design\DaVinci Resolve\Support\OpenRoto\OpenRotoBridgeBase.py"
...
Type: files; Name: "{userappdata}\Blackmagic Design\DaVinci Resolve\Fusion\OpenRoto\OpenRotoBridgeBase.py"
...
begin
  ...
  if CurStep = ssPostInstall then
    MsgBox('OpenRoto is installed for DaVinci Resolve Free and Studio.' + #13#10 + #13#10 +
      ...
      'Use Rotoscope to isolate a subject or Remove to reconstruct the background.' + #13#10 +
      'Render & Apply / Remove & Apply sends the result back to Resolve automatically.', mbInformation, MB_OK);
end;
